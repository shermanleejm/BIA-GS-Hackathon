...
const RiskProfileContainer = () => {
    ...
    return (
        completed ? <App /> :
        <Paper className='container' elevation={3} style={{'background-color': 'lightgrey'}}>
            <div className="card-body">
                ...
                <div className='row text-left mb-4'>
                    <div className='col-md-4 col-sm-12'>
                        <div className="card h-150 mb-4" style={{"box-shadow": "0px 3px 3px -2px rgba(0,0,0,0.2), 0px 3px 4px 0px rgba(0,0,0,0.14), 0px 1px 8px 0px rgba(0,0,0,0.12)"}}>
                            <div className="card-body">
